...
<div id="edit_form">
<form name="edit_domain" class="formbox" style="width: 500px;" method="post">
   <legend><?php print $PALANG['pAdminEdit_domain_welcome']; ?></legend>
   <div class="control-group">
      <h5><?php print $PALANG['pAdminEdit_domain_domain'] . ":"; ?></h5>
      <h5><?php print $domain; ?></h5>
   </div>
   <div class="control-group">
      <label><?php print $PALANG['pAdminEdit_domain_description']; ?>:</label>
   ...
   <div class="control-group">
      <label><?php print $PALANG['pAdminEdit_domain_aliases_text']; ?></label>
