...
if (authentication_has_role('global-admin')) {
   ?>
   <input class="btn" type="submit" name="fGo" value="<?php print $PALANG['pReturn_to'] . ' ' . $PALANG['pAdminMenu_list_virtual']; ?>" /></td>
   <?php 
} else { 
   ?>
   <input class="btn" type="submit" name="fGo" value="<?php print $PALANG['pReturn_to'] . ' ' . $PALANG['pMenu_overview']; ?>" /></td>
   <?php
}
?>
